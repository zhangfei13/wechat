"""
Django settings for managePlatform project.
...
SECRET_KEY = '9j417!%(9z+xga!=zqjg#_(e6(ahvx1q2aaud+@s*-pj(7%1%a'
...
WSGI_APPLICATION = 'managePlatform.wsgi.application'
